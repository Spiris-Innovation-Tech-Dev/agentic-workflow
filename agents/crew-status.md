...
Cleanup candidates (workflow complete, worktree still active):
  TASK_041  ../repo-wt/TASK_041  crew/add-feature
    -> Run: python3 {__scripts_dir__}/cleanup-worktree.py TASK_041 --remove-branch
    -> Or keep for reuse: python3 {__scripts_dir__}/cleanup-worktree.py TASK_041 --keep-on-disk
...
- **Cleanup a worktree**: `python3 {__scripts_dir__}/cleanup-worktree.py TASK_XXX --remove-branch`
